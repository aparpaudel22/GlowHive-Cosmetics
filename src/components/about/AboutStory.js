...
export default function AboutStory() {
  return (
    ...
    <section style={{ 
      background: '#fff8f5', 
      padding: 'clamp(40px, 8vh, 80px) clamp(16px, 3vw, 28px) 0px' 
    }}>
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            borderRadius: '50px',
            padding: 'clamp(5px, 0.8vw, 7px) clamp(12px, 2vw, 18px)',
            marginBottom: '16px',
          }}>
            <span style={{ fontSize: 'clamp(12px, 1.2vw, 14px)' }}>✦</span>
            <span style={{ 
        ...
        <div style={{
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <motion.div
                    ...
                    style={{
                      ...
                      borderRadius: 'clamp(30px, 4vw, 48px)',
          ...
          >
            {/* Story text */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(12px, 1.5vh, 16px)', marginBottom: 'clamp(20px, 3vh, 28px)' }}>
              <p style={{ 
                fontSize: 'clamp(14px, 1.3vw, 15px)', 
                color: '#5a3a40', 
                lineHeight: 1.8, 
            ...
            <div style={{
              ...
              paddingLeft: 'clamp(14px, 1.5vw, 18px)',
              ...
              {FEATURES.map(({ icon, label }) => (
                <motion.div
                  ...
                  style={{
                    ...
                    padding: 'clamp(14px, 2vw, 18px) clamp(8px, 1vw, 12px)',
                    textAlign: 'center', 
                    cursor: 'default',
