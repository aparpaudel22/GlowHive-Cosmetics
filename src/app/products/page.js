...
function ProductCard({ product, addToCart }) {
  ...
  return (
    <div
      ...
      style={{ 
        background: '#fff', border: '1px solid #fde8ec', borderRadius: '18px', 
    ...
    >
      ...
      <div style={{ padding: '14px', flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <p style={{ fontSize: 'clamp(12px, 1.1vw, 13px)', fontWeight: 600, color: '#3d1f25', lineHeight: 1.4, marginBottom: '8px', flex: 1 }}>
          {product.name}
        </p>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px' }}>
          <div>
            <span style={{ fontSize: 'clamp(14px, 1.3vw, 16px)', fontWeight: 800, color: '#3d1f25' }}>Rs. {product.price.toLocaleString()}</span>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: '8px', color: '#fff', fontSize: 'clamp(10px, 1vw, 11px)', fontWeight: 700,
...
export default function ProductsPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fff8f5' }}>
      ...
      {/* Hero */}
      <div style={{ background: 'linear-gradient(135deg, #fdf0f3, #fff8f5)', borderBottom: '1px solid #fde8ec', padding: 'clamp(24px, 4vw, 36px) clamp(16px, 3vw, 28px)' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          <h1 style={{ fontSize: 'clamp(24px, 4vw, 32px)', fontWeight: 800, color: '#3d1f25', fontFamily: "'Playfair Display', Georgia, serif", marginBottom: '6px' }}>
            {activeLabel}
          </h1>
          <p style={{ color: '#9ca3af', fontSize: 'clamp(13px, 1.1vw, 14px)', marginBottom: '24px' }}>
          ...
          <div style={{ position: 'relative', maxWidth: '420px' }}>
            ...
            <input
              ...
              style={{
                ...
                padding: '11px 14px 11px 40px', fontSize: 'clamp(13px, 1.1vw, 14px)', color: '#3d1f25',
      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: 'clamp(16px, 2.5vw, 24px) clamp(16px, 3vw, 28px)' }}>
          ...
          {CATEGORY_LIST.map(cat => (
            <button
              ...
              style={{
                ...
                fontSize: 'clamp(12px, 1.1vw, 13px)', fontWeight: 600, cursor: 'pointer',
                transition: 'all 0.2s',
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: 'clamp(13px, 1.1vw, 14px)', color: '#6b7280' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <select
              ...
              style={{ 
                ...
                padding: '8px 12px', fontSize: 'clamp(12px, 1.1vw, 13px)', 
                color: '#3d1f25', outline: 'none', background: '#fff', cursor: 'pointer',
                maxWidth: '160px',
              }}
            >
        ...
        {filtered.length === 0 ? (
          <div style={{ textAlign: 'center', padding: 'clamp(60px, 10vw, 80px) 28px' }}>
            <p style={{ fontSize: '48px', marginBottom: '16px' }}>🔍</p>
            <h3 style={{ fontSize: 'clamp(18px, 2.5vw, 20px)', fontWeight: 800, color: '#3d1f25', marginBottom: '8px' }}>No products found</h3>
            <p style={{ color: '#9ca3af', marginBottom: '20px', fontSize: 'clamp(13px, 1.1vw, 14px)' }}>Try a different search or category</p>
